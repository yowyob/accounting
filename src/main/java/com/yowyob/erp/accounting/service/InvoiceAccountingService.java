...
public class InvoiceAccountingService {
        ...
        private Mono<EcritureComptableDto> processDirectSupplierInvoice(UUID organization_id,
                        SupplierInvoiceDto invoice, com.yowyob.erp.accounting.entity.JournalComptable journal) {
        ...
        private Mono<EcritureComptableDto> processDirectCustomerInvoice(UUID organization_id,
                        CustomerInvoiceDto invoice, com.yowyob.erp.accounting.entity.JournalComptable journal) {
                UUID clientId = null;
                try {
        ...
        private Mono<com.yowyob.erp.accounting.entity.PeriodeComptable> findPeriode(UUID organization_id,
                        LocalDate date) {
