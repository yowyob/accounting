package com.yowyob.erp.accounting.infrastructure.messaging;
...
public class AccountingKafkaListener {
    ...
    private final EcritureComptableUseCase ecritureComptableService;
    ...
    private Mono<Void> handleInvoiceCreated(KafkaMessage message) {
        com.yowyob.erp.accounting.domain.model.FactureComptable facture = objectMapper.convertValue(message.getPayload(),
                com.yowyob.erp.accounting.domain.model.FactureComptable.class);
    ...
    private Mono<Void> handleInvoicePaid(KafkaMessage message) {
        com.yowyob.erp.accounting.domain.model.TransactionComptable transaction = objectMapper
                .convertValue(message.getPayload(), com.yowyob.erp.accounting.domain.model.TransactionComptable.class);
    ...
    private Mono<Void> handleTransactionCreated(KafkaMessage message) {
        ...
        Mono<com.yowyob.erp.accounting.domain.model.TransactionComptable> prepareTransaction;
