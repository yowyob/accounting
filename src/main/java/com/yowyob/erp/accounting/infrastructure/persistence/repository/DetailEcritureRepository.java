...
import com.yowyob.erp.accounting.domain.port.out.DetailEcritureRepositoryPort;
 ...
 */
@Repository
public interface DetailEcritureRepository extends R2dbcRepository<DetailEcriture, UUID>, DetailEcritureRepositoryPort {
