...
import com.yowyob.erp.accounting.domain.port.out.JournalAuditRepositoryPort;
 ...
 */
@Repository
public interface JournalAuditRepository extends R2dbcRepository<JournalAudit, UUID>, JournalAuditRepositoryPort {
