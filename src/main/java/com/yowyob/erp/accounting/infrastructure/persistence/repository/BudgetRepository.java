...
import com.yowyob.erp.accounting.domain.port.out.BudgetRepositoryPort;
...
@Repository
public interface BudgetRepository extends R2dbcRepository<Budget, UUID>, BudgetRepositoryPort {
