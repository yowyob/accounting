...
public class RapportController {
        ...
        private final RapportUseCase rapport_service;
        ...
        @GetMapping("/bilan")
        public Mono<ResponseEntity<ApiResponseWrapper<com.yowyob.erp.accounting.infrastructure.web.dto.report.BilanDto>>> generateBilan(
        ...
        public Mono<ResponseEntity<ApiResponseWrapper<com.yowyob.erp.accounting.infrastructure.web.dto.report.CompteResultatDto>>> generateCompteResultat(
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date_debut,
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date_fin) {
        ...
        public Mono<ResponseEntity<ApiResponseWrapper<com.yowyob.erp.accounting.infrastructure.web.dto.report.CashFlowDto>>> generateCashFlow(
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date_debut,
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date_fin) {
        ...
        public Mono<ResponseEntity<ApiResponseWrapper<com.yowyob.erp.accounting.infrastructure.web.dto.report.ExecutiveSummaryDto>>> generateExecutiveSummary(
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date_debut,
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date_fin) {
        ...
        public Mono<ResponseEntity<ApiResponseWrapper<java.util.List<com.yowyob.erp.accounting.infrastructure.web.dto.GrandLivreDto>>>> generateGrandLivre(
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date_debut,
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date_fin) {
        ...
        @GetMapping("/balance")
        public Mono<ResponseEntity<ApiResponseWrapper<com.yowyob.erp.accounting.infrastructure.web.dto.BalanceDesComptesDto>>> generateBalance(
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date_debut,
                        @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date_fin) {
                ...
                return ReactiveOrganizationContext.getOrganizationId()
                                ...
                                .flatMap(compte_resultat -> Mono.fromCallable(() -> {
                                        ...
                                        java.math.BigDecimal totalProduitsPdf = compte_resultat.getProduits().stream()
                                                        .map(com.yowyob.erp.accounting.infrastructure.web.dto.report.ReportItemDto::getSolde)
                                                        .reduce(java.math.BigDecimal.ZERO, java.math.BigDecimal::add);
        ...
        public Mono<ResponseEntity<byte[]>> exportGrandLivrePDF(
                ...
                return ReactiveOrganizationContext.getOrganizationId()
                                ...
                                .flatMap(grandLivre -> Mono.fromCallable(() -> {
                                        ...
                                        for (com.yowyob.erp.accounting.infrastructure.web.dto.GrandLivreDto compte : grandLivre) {
                                                document.add(new Paragraph(
                                                ...
                                                for (com.yowyob.erp.accounting.infrastructure.web.dto.GrandLivreDto.LigneGrandLivreDto ligne : compte
                                                                .getLignes()) {
        ...
        public Mono<ResponseEntity<byte[]>> exportBalancePDF(
                ...
                return ReactiveOrganizationContext.getOrganizationId()
                                ...
                                .flatMap(balance -> Mono.fromCallable(() -> {
                                        ...
                                        for (com.yowyob.erp.accounting.infrastructure.web.dto.BalanceDesComptesDto.LigneBalanceDto ligne : balance
                                                        .getLignes()) {
        ...
        public Mono<ResponseEntity<ApiResponseWrapper<com.yowyob.erp.accounting.infrastructure.web.dto.report.BalanceAgeeDto>>> generateBalanceAgee(
