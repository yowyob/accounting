...
import com.yowyob.erp.accounting.domain.port.out.PeriodeComptableRepositoryPort;
 ...
 */
@Repository
public interface PeriodeComptableRepository extends R2dbcRepository<PeriodeComptable, UUID>, PeriodeComptableRepositoryPort {
