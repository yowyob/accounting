...
import com.yowyob.erp.accounting.domain.port.out.AgenceRepositoryPort;
 ...
 */
@Repository
public interface AgenceRepository extends R2dbcRepository<Agence, UUID>, AgenceRepositoryPort {
