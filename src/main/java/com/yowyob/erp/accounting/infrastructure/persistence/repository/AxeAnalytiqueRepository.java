...
import com.yowyob.erp.accounting.domain.port.out.AxeAnalytiqueRepositoryPort;
...
@Repository
public interface AxeAnalytiqueRepository extends R2dbcRepository<AxeAnalytique, UUID>, AxeAnalytiqueRepositoryPort {
