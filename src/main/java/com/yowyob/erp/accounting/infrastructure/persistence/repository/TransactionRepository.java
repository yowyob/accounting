...
import com.yowyob.erp.accounting.domain.port.out.TransactionRepositoryPort;
 ...
 */
@Repository
public interface TransactionRepository extends ReactiveCrudRepository<Transaction, UUID>, TransactionRepositoryPort {
