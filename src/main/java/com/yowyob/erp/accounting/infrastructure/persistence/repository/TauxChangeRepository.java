...
import com.yowyob.erp.accounting.domain.port.out.TauxChangeRepositoryPort;
 ...
 */
@Repository
public interface TauxChangeRepository extends R2dbcRepository<TauxChange, UUID>, TauxChangeRepositoryPort {
