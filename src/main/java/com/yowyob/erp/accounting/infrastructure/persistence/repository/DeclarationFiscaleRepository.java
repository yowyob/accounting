...
import com.yowyob.erp.accounting.domain.port.out.DeclarationFiscaleRepositoryPort;
 ...
 */
@Repository
public interface DeclarationFiscaleRepository extends R2dbcRepository<DeclarationFiscale, UUID>, DeclarationFiscaleRepositoryPort {
