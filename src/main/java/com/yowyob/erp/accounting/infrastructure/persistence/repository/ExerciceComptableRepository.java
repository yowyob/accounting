...
import com.yowyob.erp.accounting.domain.port.out.ExerciceComptableRepositoryPort;
...
@Repository
public interface ExerciceComptableRepository extends R2dbcRepository<ExerciceComptable, UUID>, ExerciceComptableRepositoryPort {
