...
import com.yowyob.erp.accounting.domain.port.out.EcritureComptableRepositoryPort;
 ...
 */
@Repository
public interface EcritureComptableRepository extends R2dbcRepository<EcritureComptable, UUID>, EcritureComptableRepositoryPort {
