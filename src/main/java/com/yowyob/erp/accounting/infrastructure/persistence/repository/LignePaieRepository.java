...
import com.yowyob.erp.accounting.domain.port.out.LignePaieRepositoryPort;
...
@Repository
public interface LignePaieRepository extends R2dbcRepository<LignePaie, UUID>, LignePaieRepositoryPort {
