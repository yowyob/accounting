...
import com.yowyob.erp.accounting.domain.port.out.PlanComptableRepositoryPort;
 ...
 */
@Repository
public interface PlanComptableRepository extends R2dbcRepository<PlanComptable, UUID>, PlanComptableRepositoryPort {
