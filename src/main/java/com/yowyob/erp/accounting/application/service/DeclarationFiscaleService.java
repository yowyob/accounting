...
import com.yowyob.erp.accounting.domain.port.in.DeclarationFiscaleUseCase;
...
import com.yowyob.erp.accounting.infrastructure.persistence.repository.DeclarationFiscaleRepository;
...
@Slf4j
public class DeclarationFiscaleService implements DeclarationFiscaleUseCase {
        ...
        private final DeclarationGeneratorService generator_service;
                                        ...
                                        return entityMono.flatMap(entity -> {
                                                ...
                                                return declaration_repository.save(entity)
                                                                .flatMap(saved -> {
                                                                        ...
                                                                        String auditAction = dto.getId() != null
                                                                                        ? "TAX_DECLARATION_UPDATED"
                                                                                        : "TAX_DECLARATION_CREATED";
                                                                        String auditDetails = "Tax declaration " + (dto
                                                                                        .getNumero_declaration() != null
        ...
        /**
         * Generates a tax declaration automatically.
         * 
         * @param type  the declaration type (e.g., "TVA")
         * @param start the start date
         * @param end   the end date
         * @return the generated declaration DTO
         */
        @Transactional
        public Mono<DeclarationFiscaleDto> generateDeclaration(String type, LocalDate start, LocalDate end) {
                return ReactiveOrganizationContext.getOrganizationId()
                                .flatMap(organization_id -> {
                                        ...
                                        return Mono.error(
                                                        new BusinessException("Unsupported declaration type: " + type));
                                });
        }
}
