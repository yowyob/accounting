...
import com.yowyob.erp.accounting.domain.model.ExerciceStatut;
...
/**
 * Reactive Implementation of ExerciceComptableUseCase.
 */
@Slf4j
@Service
@RequiredArgsConstructor
public class ExerciceComptableServiceImpl implements ExerciceComptableUseCase {
        ...
        @Override
        public Mono<List<com.yowyob.erp.accounting.infrastructure.web.dto.PeriodeComptableDto>> getPeriodesByExercice(UUID exerciceId) {
                return ReactiveOrganizationContext.getOrganizationId()
                                .flatMap(organization_id -> exercice_repository.findById(exerciceId)
                                                ...
                                                .map(p -> com.yowyob.erp.accounting.infrastructure.web.dto.PeriodeComptableDto.builder()
                                                                .id(p.getId())
                                                                .code(p.getCode())
