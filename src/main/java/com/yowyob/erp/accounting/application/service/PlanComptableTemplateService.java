...
import com.yowyob.erp.accounting.domain.port.in.PlanComptableTemplateUseCase;
...
@Slf4j
public class PlanComptableTemplateService implements PlanComptableTemplateUseCase {
