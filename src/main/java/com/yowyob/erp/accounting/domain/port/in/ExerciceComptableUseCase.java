 ...
 */
public interface ExerciceComptableUseCase {
     ...
     */
    Mono<java.util.List<com.yowyob.erp.accounting.infrastructure.web.dto.PeriodeComptableDto>> getPeriodesByExercice(UUID exerciceId);
}
