...
public class CompteController {
     ...
     * 
     * @param request Map containing name, type (CLIENT/PROVIDER), and optional
     *                notes
     * @return the created account
     */
    @PostMapping("/generate")
    @Operation(summary = "Generate and create a Third-Party account")
    public ResponseEntity<ApiResponseWrapper<CompteDto>> createAutoGeneratedAccount(
        ...
        if (name == null || type == null) {
            throw new com.yowyob.erp.common.exception.BusinessException("Name and Type are required");
        }

        log.info("Request to generate {} account for {}", type, name);
        CompteDto saved = compte_service.createThirdPartyAccount(name, type, notes);

        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponseWrapper.success(saved, "Third-Party account created successfully"));
    }
