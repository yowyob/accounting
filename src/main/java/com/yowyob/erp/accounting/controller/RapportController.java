...
public class RapportController {
        ...
        public ResponseEntity<ApiResponseWrapper<Map<String, Object>>> generateCompteResultat(
                ...
                Map<String, Object> resultat = rapport_service.generateCompteResultat(tenant_id, date_debut.toString(),
                                date_fin.toString());
                log.info("📈 Income statement generated for tenant {} between {} and {}", tenant_id, date_debut,
                                date_fin);
                return ResponseEntity
                                .ok(ApiResponseWrapper.success(resultat, "Income statement generated successfully"));
        }
        ...
        public ResponseEntity<byte[]> exportBilanPDF(
                ...
                headers.add("Content-Disposition",
                                "attachment; filename=bilan_" + date_debut + "_to_" + date_fin + ".pdf");
        ...
        public ResponseEntity<byte[]> exportCompteResultatPDF(
                ...
                UUID tenant_id = TenantContext.getCurrentTenant();
                Map<String, Object> compte_resultat = rapport_service.generateCompteResultat(tenant_id,
                                date_debut.toString(),
                                date_fin.toString());
