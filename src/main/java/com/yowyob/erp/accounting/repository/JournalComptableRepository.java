...
public interface JournalComptableRepository extends R2dbcRepository<JournalComptable, UUID> {
    ...
    Flux<JournalComptable> findByTenant_Id(@Param("organization_id") UUID organization_id);

    @Query("SELECT * FROM journaux_comptables WHERE organization_id = :organization_id AND actif = true")
    Flux<JournalComptable> findByTenant_IdAndActifTrue(@Param("organization_id") UUID organization_id);

    @Query("SELECT * FROM journaux_comptables WHERE organization_id = :organization_id AND id = :id")
    Mono<JournalComptable> findByTenant_IdAndId(@Param("organization_id") UUID organization_id, @Param("id") UUID id);

    @Query("SELECT * FROM journaux_comptables WHERE organization_id = :organization_id AND code_journal = :code_journal")
    Mono<JournalComptable> findByTenant_IdAndCode_journal(@Param("organization_id") UUID organization_id,
    ...
    Flux<JournalComptable> findByTenant_IdAndType_journal(@Param("organization_id") UUID organization_id,
    ...
    Mono<Boolean> existsByTenant_IdAndCode_journal(@Param("organization_id") UUID organization_id,
            @Param("code_journal") String code_journal);
    ...
    Flux<JournalComptable> findByTenant_Id(@Param("organization_id") UUID organization_id, Pageable pageable);
    ...
    Flux<JournalComptable> findByTenant_IdAndActifTrue(@Param("organization_id") UUID organization_id, Pageable pageable);
    ...
    Mono<Boolean> existsByTenant_IdAndCode_journalAndIdNot(@Param("organization_id") UUID organization_id,
